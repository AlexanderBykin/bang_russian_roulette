      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::eProtoMessageType_IsValid(value)) {
            set_messagetype(static_cast< ::eProtoMessageType >(value));
          } else {
...
void MessageResponse::clear_messagetype() {
 ...
 ::eProtoMessageType MessageResponse::messagetype() const {
  // @@protoc_insertion_point(field_get:MessageResponse.messageType)
  return static_cast< ::eProtoMessageType >(messagetype_);
}
 void MessageResponse::set_messagetype(::eProtoMessageType value) {
