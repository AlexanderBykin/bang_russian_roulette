...
class MessageResponse : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:MessageResponse) */ {
 public:
  MessageResponse();
...
inline ::eProtoMessageType MessageResponse::messagetype() const {
  // @@protoc_insertion_point(field_get:MessageResponse.messageType)
  return static_cast< ::eProtoMessageType >(messagetype_);
}
inline void MessageResponse::set_messagetype(::eProtoMessageType value) {
