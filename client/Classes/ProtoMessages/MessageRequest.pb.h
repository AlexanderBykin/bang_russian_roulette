...
#ifndef PROTOBUF_MessageRequest_2eproto__INCLUDED
#define PROTOBUF_MessageRequest_2eproto__INCLUDED
...
void protobuf_AssignDesc_MessageRequest_2eproto();
...
class MessageRequest : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:MessageRequest) */ {
 public:
  MessageRequest();
  ...
  ::eProtoMessageType messagetype() const;
  void set_messagetype(::eProtoMessageType value);
 ...
 private:
  ...
  int messagetype_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_MessageRequest_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_MessageRequest_2eproto();
  #endif
  friend void protobuf_AssignDesc_MessageRequest_2eproto();
  friend void protobuf_ShutdownFile_MessageRequest_2eproto();
...
// required .eProtoMessageType messageType = 1 [default = cmtNone];
inline bool MessageRequest::has_messagetype() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void MessageRequest::set_has_messagetype() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MessageRequest::clear_has_messagetype() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void MessageRequest::clear_messagetype() {
  messagetype_ = 0;
  clear_has_messagetype();
}
inline ::eProtoMessageType MessageRequest::messagetype() const {
  // @@protoc_insertion_point(field_get:MessageRequest.messageType)
  return static_cast< ::eProtoMessageType >(messagetype_);
}
inline void MessageRequest::set_messagetype(::eProtoMessageType value) {
  assert(::eProtoMessageType_IsValid(value));
  set_has_messagetype();
  messagetype_ = value;
...
// required bytes messageBody = 2 [default = "\000"];
inline bool MessageRequest::has_messagebody() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void MessageRequest::set_has_messagebody() {
  _has_bits_[0] |= 0x00000002u;
}
inline void MessageRequest::clear_has_messagebody() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void MessageRequest::clear_messagebody() {
  messagebody_.ClearToDefaultNoArena(_default_messagebody_);
  clear_has_messagebody();
}
inline const ::std::string& MessageRequest::messagebody() const {
  // @@protoc_insertion_point(field_get:MessageRequest.messageBody)
  return messagebody_.GetNoArena(_default_messagebody_);
}
inline void MessageRequest::set_messagebody(const ::std::string& value) {
  set_has_messagebody();
  messagebody_.SetNoArena(_default_messagebody_, value);
  // @@protoc_insertion_point(field_set:MessageRequest.messageBody)
}
inline void MessageRequest::set_messagebody(const char* value) {
  set_has_messagebody();
...
inline void MessageRequest::set_messagebody(const void* value, size_t size) {
  set_has_messagebody();
...
#endif  // PROTOBUF_MessageRequest_2eproto__INCLUDED
