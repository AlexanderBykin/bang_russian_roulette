...
public final class MessageResponseBase {
  ...
  public interface MessageResponseOrBuilder extends
    ...
    /**
     * <code>required .eProtoMessageType messageType = 1 [default = cmtNone];</code>
     */
    boolean hasMessageType();
    /**
     * <code>required .eProtoMessageType messageType = 1 [default = cmtNone];</code>
     */
    ProtoMessages.ProtoMessageTypeBase.eProtoMessageType getMessageType();
  ...
  public  static final class MessageResponse extends
    ...
    private MessageResponse() {
      messageBody_ = MESSAGEBODY_DEFAULT_VALUE;
    }
     ...
     * <code>required .eProtoMessageType messageType = 1 [default = cmtNone];</code>
     */
    public ProtoMessages.ProtoMessageTypeBase.eProtoMessageType getMessageType() {
      ProtoMessages.ProtoMessageTypeBase.eProtoMessageType result = ProtoMessages.ProtoMessageTypeBase.eProtoMessageType.forNumber(messageType_);
      return result == null ? ProtoMessages.ProtoMessageTypeBase.eProtoMessageType.cmtNone : result;
    }
    /**
     * <code>required .eProtoMessageType messageType = 1 [default = cmtNone];</code>
     */
    private void setMessageType(ProtoMessages.ProtoMessageTypeBase.eProtoMessageType value) {
      if (value == null) {
    ...
    private static final com.google.protobuf.ByteString MESSAGEBODY_DEFAULT_VALUE = com.google.protobuf.Internal.bytesDefaultValue("\000");
  ...
  bitField0_ |= 0x00000002;
    ...
    public static final class Builder extends
       ...
       * <code>required .eProtoMessageType messageType = 1 [default = cmtNone];</code>
       */
      public Builder setMessageType(ProtoMessages.ProtoMessageTypeBase.eProtoMessageType value) {
        copyOnWrite();
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          ProtoMessages.MessageResponseBase.MessageResponse other = (ProtoMessages.MessageResponseBase.MessageResponse) arg1;
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 8: {
                  ...
                  ProtoMessages.ProtoMessageTypeBase.eProtoMessageType value = ProtoMessages.ProtoMessageTypeBase.eProtoMessageType.forNumber(rawValue);
                  if (value == null) {
