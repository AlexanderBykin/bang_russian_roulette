...
public interface PlayerDao
{
    ...
    /**
     * Transforms the given results to a collection of {@link Player}
    ...
    /**
     * Gets an instance of Player from the persistent store.
     * @param id
     * @return Player
     */
    ...
    /**
     * Loads an instance of Player from the persistent store.
     * @param id
     * @return Player
     */
    ...
    /**
     * Loads all entities of type {@link Player}.
     *
    ...
    /**
     * Creates an instance of Player and adds it to the persistent store.
     * @param player
     * @return Player
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(Player)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, Player player);

    /**
     * Creates a new instance of Player and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of Player
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<Player> create(Collection<Player> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<Player> entities);
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(Integer, Integer, Long, byte[], UserRoleType, AuthType, String, String, String, String, Boolean, Boolean, String, Date, Date, Date, Boolean)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>player</code> instance in the persistent store.
     * @param player
     */
     ...
     * @param entities
     */
    public void update(Collection<Player> entities);

    /**
     * Removes the instance of Player from the persistent store.
     * @param player
     */
    public void remove(Player player);

    /**
     * Removes the instance of Player having the given
     ...
     * flag is set to one of the constants defined in <code>net.orionlab.brr.domain.PlayerDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link net.orionlab.brr.domain.PlayerDao}
     ...
     * {@link #transformEntity(int,Player)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>net.orionlab.brr.domain.PlayerDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,Player)
     */
