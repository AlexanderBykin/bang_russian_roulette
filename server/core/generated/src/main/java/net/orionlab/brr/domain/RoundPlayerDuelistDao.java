 ...
 */
public interface RoundPlayerDuelistDao
{
    /**
    ...
    /**
     * Transforms the given results to a collection of {@link RoundPlayerDuelist}
    ...
    /**
     * Gets an instance of RoundPlayerDuelist from the persistent store.
     * @param id
    ...
    /**
     * Loads an instance of RoundPlayerDuelist from the persistent store.
     * @param id
     * @return RoundPlayerDuelist
     */
    ...
    /**
     * Loads all entities of type {@link RoundPlayerDuelist}.
     *
    ...
    /**
     * Creates an instance of RoundPlayerDuelist and adds it to the persistent store.
     * @param roundPlayerDuelist
     * @return RoundPlayerDuelist
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(RoundPlayerDuelist)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, RoundPlayerDuelist roundPlayerDuelist);

    /**
     * Creates a new instance of RoundPlayerDuelist and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of RoundPlayerDuelist
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<RoundPlayerDuelist> create(Collection<RoundPlayerDuelist> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<RoundPlayerDuelist> entities);

    /**
     * <p>
     * Creates a new <code>RoundPlayerDuelist</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(Integer, Boolean, Long, Date, Date, Boolean)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>roundPlayerDuelist</code> instance in the persistent store.
     * @param roundPlayerDuelist
     */
     ...
     * @param entities
     */
    public void update(Collection<RoundPlayerDuelist> entities);

    /**
     * Removes the instance of RoundPlayerDuelist from the persistent store.
     * @param roundPlayerDuelist
     */
    public void remove(RoundPlayerDuelist roundPlayerDuelist);

    /**
     * Removes the instance of RoundPlayerDuelist having the given
     ...
     * flag is set to one of the constants defined in <code>net.orionlab.brr.domain.RoundPlayerDuelistDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link net.orionlab.brr.domain.RoundPlayerDuelistDao}
     ...
     * {@link #transformEntity(int,RoundPlayerDuelist)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>net.orionlab.brr.domain.RoundPlayerDuelistDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,RoundPlayerDuelist)
     */
