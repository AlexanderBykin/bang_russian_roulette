...
public interface RoomDao
{
    ...
    /**
     * Transforms the given results to a collection of {@link Room}
    ...
    /**
     * Gets an instance of Room from the persistent store.
     * @param id
     * @return Room
     */
    ...
    /**
     * Loads an instance of Room from the persistent store.
     * @param id
     * @return Room
     */
    ...
    /**
     * Loads all entities of type {@link Room}.
     *
    ...
    /**
     * Creates an instance of Room and adds it to the persistent store.
     * @param room
     * @return Room
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(Room)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, Room room);

    /**
     * Creates a new instance of Room and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of Room
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<Room> create(Collection<Room> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<Room> entities);

    /**
     * <p>
     * Creates a new <code>Room</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(RoomType, Integer, Integer, Integer, Long, Long, Integer, Boolean, Date, Date, Boolean)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>room</code> instance in the persistent store.
     * @param room
     */
     ...
     * @param entities
     */
    public void update(Collection<Room> entities);

    /**
     * Removes the instance of Room from the persistent store.
     * @param room
     */
    public void remove(Room room);

    /**
     * Removes the instance of Room having the given
     ...
     * flag is set to one of the constants defined in <code>net.orionlab.brr.domain.RoomDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link net.orionlab.brr.domain.RoomDao}
     ...
     * {@link #transformEntity(int,Room)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>net.orionlab.brr.domain.RoomDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,Room)
     */
