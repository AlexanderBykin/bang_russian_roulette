...
public interface AbstractUserDao
{
    ...
    /**
     * Transforms the given results to a collection of {@link AbstractUser}
    ...
    /**
     * Gets an instance of AbstractUser from the persistent store.
     * @param id
     * @return AbstractUser
     */
    ...
    /**
     * Loads an instance of AbstractUser from the persistent store.
     * @param id
     * @return AbstractUser
     */
    ...
    /**
     * Loads all entities of type {@link AbstractUser}.
     *
    ...
    /**
     * Creates an instance of AbstractUser and adds it to the persistent store.
     * @param abstractUser
     * @return AbstractUser
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(AbstractUser)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, AbstractUser abstractUser);

    /**
     * Creates a new instance of AbstractUser and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of AbstractUser
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<AbstractUser> create(Collection<AbstractUser> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<AbstractUser> entities);

    /**
     * <p>
     * Creates a new <code>AbstractUser</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(UserRoleType, AuthType, String, String, String, String, Boolean, Boolean, String, Date, Date, Date, Boolean)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>abstractUser</code> instance in the persistent store.
     * @param abstractUser
     */
     ...
     * @param entities
     */
    public void update(Collection<AbstractUser> entities);

    /**
     * Removes the instance of AbstractUser from the persistent store.
     * @param abstractUser
     */
    public void remove(AbstractUser abstractUser);

    /**
     * Removes the instance of AbstractUser having the given
     ...
     * flag is set to one of the constants defined in <code>net.orionlab.brr.domain.AbstractUserDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link net.orionlab.brr.domain.AbstractUserDao}
     ...
     * {@link #transformEntity(int,AbstractUser)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>net.orionlab.brr.domain.AbstractUserDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,AbstractUser)
     */
